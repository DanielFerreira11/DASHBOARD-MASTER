...
//Criando grafico de acidentes por Estado Fisico em determinado Estado
    ...
    $scope.gerarTeste = function(){ 
        limparGrafico()
        limparMapBrasil()
        $scope.requisicao = true;
        systemService.getTeste().
        then(function successCalback(response){
            $scope.requisicao = false;
                ...
                let option = {
                    ...
                    display: true,
                    fontSize: 28,
                    text: 'Número de acidentes por tipo de veículo: ' //titulo do grafico
                },
                legend: {
                    display: true,
                    position: 'bottom',
                ...
                criaGrafico(response.data,"pie",option) //tipo de grafico, neste caso foi criado o grafico de rosca
        },
        function errorCallback(response){
            console.error('Erro ' + response);
        });
    ...
    $scope.gerarMortos = function(){ 
        limparGrafico()
        limparMapBrasil()
        $scope.requisicao = true;
        systemService.getMortos().
        then(function successCalback(response){
            $scope.requisicao = false;
                ...
                let option = {
                    ...
                    display: true,
                    fontSize: 28,
                    text: 'Vítimas Fatais por estado: ' //titulo do grafico
                },
                legend: {
                    display: true,
                    position: 'bottom',
    ...
    $scope.gerarMetereologia = function(){ 
        limparGrafico()
        limparMapBrasil()
        $scope.requisicao = true;
        systemService.getMetereologia().
        then(function successCalback(response){
            $scope.requisicao = false;
                ...
                let option = {
                    ...
                    display: true,
                    fontSize: 28,
                    text: 'Causas de Acidentes por condição meteorológica: ' //titulo do grafico
                },
                legend: {
                    display: true,
                    position: 'bottom',
                ...
                criaGrafico(response.data,"bar",option) //tipo de grafico, neste caso foi criado o grafico de rosca
        },
        function errorCallback(response){
            console.error('Erro ' + response);
        });
    ...
    // fase dia
    $scope.gerarFaseDia = function(){ 
        limparGrafico()
        limparMapBrasil()
        $scope.requisicao = true;
        systemService.getFaseDia().
        then(function successCalback(response){
            $scope.requisicao = false;
                ...
                let option = {
                    ...
                    display: true,
                    fontSize: 28,
                    text: 'Número de acidentes por fases do dia: ' //titulo do grafico
                },
                legend: {
                    display: true,
                    position: 'bottom',
