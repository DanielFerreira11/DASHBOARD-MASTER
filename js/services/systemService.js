...
app.factory("systemService", function($http){
  ...
  var _getTeste = function() {
    return $http.get('http://127.0.0.1:5000/api/Testa');
  };

  var _getMortos = function() {
    return $http.get('http://127.0.0.1:5000/api/Mortos');
  };

  var _getMetereologia = function() {
    return $http.get('http://127.0.0.1:5000/api/Metereologia');
  };

  var _getFaseDia = function() {
    return $http.get('http://127.0.0.1:5000/api/FaseDia_Resource');
  };
...
return {
  ...
  getTeste: _getTeste,
  getMortos: _getMortos,
  getMetereologia: _getMetereologia,
  getFaseDia: _getFaseDia
